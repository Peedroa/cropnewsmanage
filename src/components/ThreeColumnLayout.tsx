    ...
    setColumnWidths(prev => {
      ...
      switch (activeResizer) {
        case 'sources-text':
          ...
          const newTextWidth = Math.max(8, Math.min(40, 100 - newSourcesWidth - prev.fullpage - prev.clips));
          newWidths.sources = newSourcesWidth;
          newWidths.text = newTextWidth;
          break;

        case 'text-fullpage':
          const newTextWidth2 = Math.max(8, Math.min(40, mousePercent - prev.sources));
